...
#ifndef SRC_APPLICATION_CODE_PSA_INTERNAL_TRUSTED_STORAGE_H_
#define SRC_APPLICATION_CODE_PSA_INTERNAL_TRUSTED_STORAGE_H_
...
#endif /* SRC_APPLICATION_CODE_PSA_INTERNAL_TRUSTED_STORAGE_H_ */
